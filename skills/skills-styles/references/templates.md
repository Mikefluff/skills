...
- Meta-tags from the canonical taxonomy at:
  - `skills/music-prompt/references/meta-tags.md` (8 categories)
  - `skills/music-prompt/references/vocal-tags.md`
  - `skills/music-prompt/references/instrumental-tags.md`
  - `skills/music-prompt/references/mix-production-tags.md`
