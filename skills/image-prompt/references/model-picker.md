...
- **Editorial / fashion / "vibes"** → Midjourney V8.1 → [`models/midjourney.md`](models/midjourney.md)
- **Photoreal portrait / product (max detail)** → Flux 2 Pro or Nano Banana Pro → [`models/flux.md`](models/flux.md) / [`models/google.md`](models/google.md)
...
- **Character consistency across multiple images** → Nano Banana Pro (up to 5 people) / gpt-image-2 (up to 16 refs) / Flux Kontext / Seedream 5.0 (weighted) → load [`editing-prompting.md`](editing-prompting.md)
- **Multi-image composition** (character + product + style mix) → Seedream 5.0 weighted refs or Flux 2 Pro multi-ref → load [`editing-prompting.md`](editing-prompting.md)
- **Vector / SVG / flat icon** → Recraft V3 → [`models/ideogram-recraft.md`](models/ideogram-recraft.md)
- **Fast cheap iteration** → Flux Schnell, Nano Banana 2 Lite, Ideogram 3 Flash, SDXL Lightning, Seedream 5 Lite
...
|---|---|---|---|---|---|---|---|
| Midjourney V8.1 | ✓ | partial (≤5 words) | partial (`--oref`) | partial | ✓ (`--oref`) | no | no |
...
| Nano Banana 2 | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | no |
| Nano Banana 2 Lite | partial | partial | ✓ | partial | partial | ✓ | no |
...
| Seedream 5.0 Pro | ✓ | ✓ (14 langs) | ✓ (layered) | ✓ (weighted) | ✓ | ✓ | no |
...
If you just want one good model and one fallback:
  - Midjourney V8.1    → editorial / vibes
