...
The schema is also the structured input to `skills/prose-edit/references/patch-refining.md` — patches consume validation findings to produce surgical fixes.
