...
echo
echo "─── 2/12 writer/lint.py self-test ─────────────────────────────"
...
echo
echo "─── 3/12 fixture snapshots ────────────────────────────────────"
bash tests/run.sh

echo
echo "─── 4/12 AFTER calibration samples ────────────────────────────"
...
echo
echo "─── 8/12 markdownlint (CI-pinned version) ─────────────────────"
...
echo
echo "─── 12/12 runners import smoke ─────────────────────────────────"
