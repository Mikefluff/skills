...
echo
echo "─── 2/9 writer/lint.py self-test ─────────────────────────────"
...
echo
echo "─── 3/9 fixture snapshots ────────────────────────────────────"
bash tests/run.sh

echo
echo "─── 4/9 AFTER calibration samples ────────────────────────────"
...
echo
echo "─── 8/9 markdownlint (CI-pinned version) ─────────────────────"
