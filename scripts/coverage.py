...
`skills/writer/references/neuroslop-categories.md` are actually detected by regex in
`skills/writer/scripts/lint_patterns.py`, and how many patterns each category has.
...
CAT_FILE = ROOT / "skills" / "writer" / "references" / "neuroslop-categories.md"
LINT_FILE = ROOT / "skills" / "writer" / "scripts" / "lint_patterns.py"
