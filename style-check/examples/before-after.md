...
- The **linter-report excerpt** is exactly what style-check would emit for each version. The category labels match `writer/references/neuroslop-categories.md` and the severity scale matches `references/severity.md`.
