# Neuroslop Regex Categories — 25 RU buckets + 18 EN signatures
...
Всё в этом файле — **вероятностные** сигналы, они работают кластерами. Один хит не значит ничего. Категорически иное — артефакты копипаста из чат-ботов: там один хит равен вердикту, см. [copypaste-artifacts.md](copypaste-artifacts.md).

Найдя хит, не подставляйте синоним. Слоп, заменённый родственным слопом, остаётся слопом — иерархия лечения и таблица запрещённых замен в [forbidden-substitutions.md](forbidden-substitutions.md).
...
## 24. THERAPEUTIC — псевдо-терапевтический регистр

Модель имитирует эмпатию формулами поддержки из self-help. В тексте не про психологию они звучат чужим голосом — как будто в середине статьи включился коуч.

- «И это нормально» / «И это окей»
- «Вы не одиноки» / «Ты не один такой»
- «Давайте признаем»
- «Позвольте себе»
- «Это абсолютно естественно»
- «Будьте к себе добрее»
- EN: "and that's okay", "you're not alone", "give yourself permission", "be gentle with yourself"

**Не путать с SELFHELP (13).** Там фальшивый драйв — императивы «выйди из зоны комфорта», «раскрой потенциал». Здесь фальшивая забота. Родственники, маркеры разные.

- БЫЛО: «Не все успевают следить за новостями ИИ. И это нормально. Вы не одиноки в этом чувстве.»
- НАДО: «За новостями ИИ не успевает никто: за неделю выходит больше моделей, чем успеваешь попробовать за месяц.»

Filter: в тексте, который действительно про терапию, выгорание или психологическую помощь, эти обороты — жанровая норма. Правьте, только если регистр не соответствует теме.

## 25. FALSE_RANGE — ложные диапазоны

«От X до Y» там, где X и Y не лежат на одной шкале. Модель имитирует охват, перечисляя две случайные точки как будто это границы континуума.

- «От аналитики до продаж», «от стартапов до корпораций», «от новичков до профессионалов»
- EN: "from strategy to execution", "from startups to enterprises"

Лечение: развернуть в обычное перечисление. «От анализа данных до стратегического планирования, от маркетинга до продаж» → «Мы занимаемся аналитикой, планированием, маркетингом и продажами».

Filter: настоящие шкалы оставлять — «от 5 до 10 миллионов», «от Москвы до Владивостока», «от -40 до +50». Регексом эта категория не ловится (слишком много легитимных диапазонов), проверка ручная.
